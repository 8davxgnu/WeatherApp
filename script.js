...
//-----------------------------------------------------------------------------------------
//  Define the CheckWeather Function (this runs whenever the search button is clicked (only clicked for now...))
async function checkWeather(city) {
  ...
  if (response.status == 404) {
    // If ERROR/404 from api URL data fetch
  ...
  document.querySelector(".temp").innerHTML =
    Math.round((data.main.temp * 10) / 10).toFixed(1) + "°C";
